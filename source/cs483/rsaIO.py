...
def parse():
    ...
    parser.add_argument("-i", dest="input_file",help="Message to hash using SHA256")
    parser.add_argument("-o", dest="output_file",help="Output file for rsa-sign, input for rsa-validate")
